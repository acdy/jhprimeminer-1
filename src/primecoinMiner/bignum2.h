...
public:
	...
	~CAutoBN_CTX()
	{
		if (pctx != NULL)
		{ 
			//printf("CAutoBN_CTX delete real\n");
			BN_CTX_free(pctx);
		}
	}
...
public:
	...
	{
		BN_init(this);
		//BN_set_flags(this, BN_FLG_MALLOCED);
		//this->flags &= ~BN_FLG_MALLOCED;
		//this->flags |= BN_FLG_STATIC_DATA;
		//this->d = (unsigned int*)bignumStackData;
		//this->dmax = 0x200/4;
	}
	...
	~CBigNum()
	{
		//if( this->d != (unsigned int*)bignumStackData )
		//	__debugbreak();
		//this->flags &= ~BN_FLG_STATIC_DATA;
		//this->d = 0;
		//if( this->d != (unsigned int*)bignumStackData )
